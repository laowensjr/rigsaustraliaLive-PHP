...
<div style="width: 100%; overflow: hidden;">
    <div style="width: 600px; float: left;"> Logo</div>
...
<div style="width: 100%; overflow: hidden;">
  ...
  <tr>
    ...
    <td width="66%" align="left" valign="top" class="myNAMETitle"><br />
      Name: <?php echo @$_SESSION[fname] ." ". @$_SESSION[lname];?><br /><br />
      Contact Details:<br /></td>
  </tr>
  <tr>
    <td align="left" valign="top" class="myNAMEDetails"><br />
    Company: <?php echo @$_SESSION[fname] ." ". @$_SESSION[lname];
	echo '<br />';
    ...
    <div style="width: 100%; overflow: hidden;">
    <div style="width: 600px; float: left;"> Optional UseBox</div>
