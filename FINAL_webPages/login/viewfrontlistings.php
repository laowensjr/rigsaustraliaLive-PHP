...
<title>View Front Page Listings</title>
<style type="text/css">
<!--
body {
...
<div style="width: 100%; overflow: hidden;">
    ...
    <div style="margin-left: 600px; width: 600px; height:49px; background-image:url(adminBarUI/images/whole.jpg); background-repeat:no-repeat; padding-top:6px;">
      <form action="adminTaskBar.php" method="POST" enctype="multipart/form-data" name="adminTaskBar">
        &nbsp;&nbsp;&nbsp; Business Name (optional)&nbsp;&nbsp; 
        <input name="bizname" type="text" size="10" maxlength="20"  style=" "/>
or        &nbsp;&nbsp;&nbsp;          
        <select name="tasks" id="tasks" size="1" style="width:120px">
      <option value="default" class="inputText">Select A Task</option>
      ...
      <option value="viewfront" selected="selected">View FrontPageAds</option>
    </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<br/>
<div style="width: 100%; overflow: hidden;">
  <div style="margin-left:10px; width: 600px; float: left; " id="myTitleNOUnderline" align="left">View Front Page Listings</div>
  ...
  <tr>
    <td align="left" valign="top"><br />
     <?php include('classes/viewFrontListings.php'); ?>
     <?php 
	 if(!empty($_GET['bizname'])){
		$runFrontListing = new viewFrontListings();
		$runFrontListing->getSFPListings();
	 }else{
		$runFrontListing = new viewFrontListings();
		$runFrontListing->getAllFrontListings();
	 }
