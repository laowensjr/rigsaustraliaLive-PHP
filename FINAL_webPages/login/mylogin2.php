...
<!-- jQuery - the core -->
	<script src="loginBar/js/jquery-1.3.2.min.js" type="text/javascript"></script>
	<!-- Sliding effect -->
	<script src="loginBar/js/slide.js" type="text/javascript"></script>
<link href="../css/rigSaleAustraliaCSS.css" rel="stylesheet" type="text/css" />
<link href="loginBar/css/slide.css" rel="stylesheet" type="text/css" />
 <link href="loginBar/css/style.css" rel="stylesheet" type="text/css" />
</head>
<body>
 <div id>
 
 <?php include('loginBar/loginBar.php'); ?></div><br/>
<br/><br/>
