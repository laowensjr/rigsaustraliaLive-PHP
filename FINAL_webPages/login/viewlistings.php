...
<select name="tasks" id="tasks" size="1" style="width:120px">
      ...
      <option value="viewlistings" selected="selected">View Listings</option>
...
<br/>
<div style="width: 100%; overflow: hidden;">
  <div style="margin-left:10px; width: 600px; float: left; " id="myTitleNOUnderline" align="left">View Listings</div>
  ...
  <tr>
    <td align="left" valign="top"><br />
     <?php include('classes/viewListings.php'); ?>
     <?php 
	 if(!empty($_GET['bizname'])){
		$runListing = new viewListings();
		$runListing->getSListing();
	 }else{
		$runListing = new viewListings();
		$runListing->getAllListings();
	 }
