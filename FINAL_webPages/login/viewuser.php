...
<select name="tasks" id="tasks" size="1" style="width:120px">
      ...
      <option value="viewuser" selected="selected">View Users</option>
...
<br/>
<div style="width: 100%; overflow: hidden;">
  <div style="margin-left:10px; width: 600px; float: left; " id="myTitleNOUnderline" align="left">View User</div>
