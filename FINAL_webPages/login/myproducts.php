...
<div>
      ...
      <div style="margin-left: 10px; background-color:#FFF">
        <table width="100%" border="0" cellspacing="1" cellpadding="1">
          <tr>
            <td colspan="2" align="center" valign="top"><img src="../images/backendHeaders/BACKENDimageHEADERS.jpg" width="1216" height="192" /></td>
          </tr>
  </table>
...
<div style="width: 100%; overflow: hidden;">
  <div style="margin-left:10px; width: 600px; float: left; color: #000;" id="myTitleNOUnderline" align="left"><br />My Rig/Equipment Details<br /></div>
    ...
    <div style="width: 100%; overflow: hidden;">
    <div style="margin-left:10px; width: 600px; float: left; height: 1050px; width: 600px; border: 1px solid black; background-color: #FF9" align="left">
  ...
  <tr>
    <td align="center" valign="top" bgcolor="#0000FF" class="whiteMyDetails">Your items in the trash will be permanantly deleted within 24hrs...<br />
