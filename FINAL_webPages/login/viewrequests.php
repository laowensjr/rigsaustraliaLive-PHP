...
<select name="tasks" id="tasks" size="1" style="width:120px">
      ...
      <option value="approvalrequests" selected="selected">View Approval Requests</option>
...
<br/>
<div style="width: 100%; overflow: hidden;">
  <div style="margin-left:10px; width: 600px; float: left; " id="myTitleNOUnderline" align="left">View Requests</div>
  ...
  <tr>
    <td align="left" valign="top"><br />
     <?php include('classes/viewRequests.php'); ?>
     <?php 
	 if(!empty($_GET['bizname'])){
		$runRequest = new viewRequests();
		$runRequest->getSRequests();
	 }else{
		$runRequest = new viewRequests();
		$runRequest->getAllPRequests();
	 }
