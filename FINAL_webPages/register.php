...
if(!empty($_POST['username']) && !empty($_POST['pass']) && !empty($_POST['email']) && !empty($_POST['fname']) && !empty($_POST['lname']) && !empty($_POST['bizname']) && !empty($_POST['phone']) ){
	if ($check2 != 0){
 	...
 	?>
    <img src="registration/images/sLogo.jpg" width="296" height="64" alt="Rig Sales Australia">
<h1>Registered</h1>
 <p>Thank you, you have registered - you may now <a href="login/mylogin.php">login</a>.</p>
 <?php 
}
} 
 else 
 ...
 <form action="<?php echo $_SERVER['registration/PHP_SELF']; ?>" method="post">
