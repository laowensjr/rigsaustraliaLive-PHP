...
<table style="width:608px; height:193px;" border="0" align="center" cellpadding="0" cellspacing="0" id="Table_01"  >
	...
	<tr>
		<td width="122" height="96" align="center" valign="middle" bgcolor="#ECECEC"><a href="moredetails.php?id=<?php echo $id; ?>&ptitle=<?php echo $ptitle; ?>"><img src='<?php echo "../login/$o1img"; ?>' width="100" height="89" alt="Original Image 1" border="1px" ></a></td>
