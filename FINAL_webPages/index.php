...
<table id="Table_01" width="1225" height="1585" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#FFFFFF" style="border: 2px solid #ffffff; padding: 1px 4px; border-radius: 50px; azimuth:center;" >
	<tr>
		...
		<td width="273" height="55" colspan="17" rowspan="2">
   ...
   //Set Cookies
	$username = $_COOKIE['logincookie']; 
 	$pass = $_COOKIE['passcookie'];
 	 	//$check = $mysql->query("SELECT * FROM sellers WHERE username = '$username'")
		if(!$check = $mysqli->query("SELECT * FROM sellers WHERE username = '$username'")){
...
echo 'Welcome '.$info['bizname'].'! <a href="login/overview.php">Your Dashboard</a> '; 
 ...
 // makes sure they filled it in
	...
	$check = $mysqli->query("SELECT * FROM sellers WHERE username = '".$_POST['username']."'") or die($mysqli->error);//or die(mysql_error());
 ...
 ?> 
	...
	<tr>
		<td colspan="13" rowspan="3">
			<a href="rigsalesaustralia.com">
				<img src="images/bigLogoHome.jpg" width="612" height="107" border="0" alt="Rig Sales Australia"></a></td>
	...
	<tr>
		...
		<td colspan="25" rowspan="9">
			<img src="images/middlePic_Center.jpg" width="770" height="472" alt=""></td>
		<td>
	...
	<tr>
		<td colspan="4" rowspan="8">
			<img src="images/index_18.jpg" width="92" height="276" alt=""></td>
	...
	<tr>
		<td colspan="25">
			<img src="images/index_26.jpg" width="770" height="21" alt=""></td>
		<td>
			<img src="images/spacer.gif" width="1" height="21" alt=""></td>
	</tr>
	<tr>
		<td colspan="4">
			<img src="images/index_27.jpg" width="281" height="1" alt=""></td>
		...
		<td rowspan="6">
			<img src="images/index_29.jpg" width="60" height="148" alt=""></td>
		<td colspan="3" rowspan="5"><a href="inventory/inventory.php?page=surplus" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image147','','images/surplusOVER.jpg',1)"><img src="images/surplus.jpg" name="Image147" width="268" height="135" border="0"></a></td>
		<td colspan="17" rowspan="2">
			<img src="images/index_31.jpg" width="273" height="5" alt=""></td>
		<td>
			<img src="images/spacer.gif" width="1" height="1" alt=""></td>
	</tr>
	<tr>
		<td colspan="3" rowspan="5">
			<img src="images/index_32.jpg" width="40" height="147" alt=""></td>
		...
		<td rowspan="5">
			<img src="images/index_34.jpg" width="58" height="147" alt=""></td>
		<td>
			<img src="images/spacer.gif" width="1" height="4" alt=""></td>
	</tr>
	<tr>
		<td colspan="4" rowspan="4">
			<img src="images/index_35.jpg" width="34" height="143" alt=""></td>
		<td colspan="10" rowspan="2"><a href="inventory/inventory.php?page=newprodsnservices" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image148','','images/newProductOVER.jpg',1)"><img src="images/newProduct.jpg" name="Image148" width="200" height="125" border="0"></a></td>
		<td colspan="3" rowspan="5">
			<img src="images/index_37.jpg" width="39" height="157" alt=""></td>
		<td>
			<img src="images/spacer.gif" width="1" height="112" alt=""></td>
	</tr>
	<tr>
		<td colspan="4" rowspan="3">
			<img src="images/index_38.jpg" width="275" height="31" alt=""></td>
		<td colspan="6" rowspan="3">
			<img src="images/index_39.jpg" width="250" height="31" alt=""></td>
		<td>
			<img src="images/spacer.gif" width="1" height="13" alt=""></td>
	</tr>
	<tr>
		<td colspan="10" rowspan="3">
			<img src="images/index_40.jpg" width="200" height="32" alt=""></td>
		<td>
			<img src="images/spacer.gif" width="1" height="5" alt=""></td>
	</tr>
	<tr>
		<td colspan="3">
			<img src="images/index_41.jpg" width="268" height="13" alt=""></td>
		<td>
			<img src="images/spacer.gif" width="1" height="13" alt=""></td>
	</tr>
	<tr>
		<td rowspan="14">
			<img src="images/index_42.jpg" width="20" height="813" alt=""></td>
		<td width="956" height="670" colspan="19" rowspan="7"><img src="images/images/premium6.jpg" width="956" height="670"></td>
		<td colspan="2">
			<img src="images/index_44.jpg" width="9" height="14" alt=""></td>
		<td>
			<img src="images/spacer.gif" width="1" height="14" alt=""></td>
	</tr>
	<tr>
		<td rowspan="13">
			<img src="images/index_45.jpg" width="5" height="799" alt=""></td>
		<td colspan="12"><a href="advertise.php?sidead=1"><img src="images/sideADspace.jpg" alt="" width="208" height="485" border="0"></a></td>
		<td colspan="2" rowspan="8">
			<img src="images/index_47.jpg" width="35" height="699" alt=""></td>
		<td>
			<img src="images/spacer.gif" width="1" height="485" alt=""></td>
	</tr>
	<tr>
		<td colspan="12">
			<img src="images/index_48.jpg" width="208" height="23" alt=""></td>
		<td>
			<img src="images/spacer.gif" width="1" height="23" alt=""></td>
	</tr>
	<tr>
		<td colspan="5" rowspan="2">
			<img src="images/index_49.jpg" width="71" height="66" alt=""></td>
		...
		<td colspan="4" rowspan="2">
			<img src="images/index_51.jpg" width="65" height="66" alt=""></td>
		<td>
			<img src="images/spacer.gif" width="1" height="13" alt=""></td>
	</tr>
	<tr>
		<td colspan="3">
			<img src="images/index_52.jpg" width="72" height="53" alt=""></td>
		<td>
			<img src="images/spacer.gif" width="1" height="53" alt=""></td>
	</tr>
	<tr>
		<td colspan="3" rowspan="9">
			<img src="images/index_53.jpg" width="35" height="225" alt=""></td>
		...
		<td colspan="2" rowspan="4">
			<img src="images/index_55.jpg" width="19" height="125" alt=""></td>
		<td>
			<img src="images/spacer.gif" width="1" height="56" alt=""></td>
	</tr>
	<tr>
		<td colspan="7" rowspan="3">
			<img src="images/index_56.jpg" width="154" height="69" alt=""></td>
		<td>
			<img src="images/spacer.gif" width="1" height="26" alt=""></td>
	</tr>
	<tr>
		<td colspan="19">
			<img src="images/index_57.jpg" width="956" height="14" alt=""></td>
		<td>
			<img src="images/spacer.gif" width="1" height="14" alt=""></td>
	</tr>
	<tr>
		<td rowspan="6">
			<img src="images/index_58.jpg" width="11" height="129" alt=""></td>
		<td colspan="3" rowspan="4">
			<a href="advertise.php?footerad=1">
				<img src="images/footerAD1.jpg" width="223" height="115" border="0" alt=""></a></td>
		<td rowspan="4">
			<img src="images/index_60.jpg" width="8" height="115" alt=""></td>
		<td colspan="5" rowspan="4">
			<a href="advertise.php?footerad=2">
				<img src="images/footerAD2.jpg" width="223" height="115" border="0" alt=""></a></td>
		<td rowspan="4">
			<img src="images/index_62.jpg" width="11" height="115" alt=""></td>
		<td colspan="4" rowspan="4">
			<a href="advertise.php?footerad=3">
				<img src="images/footerAD3.jpg" width="222" height="115" border="0" alt=""></a></td>
		<td rowspan="4">
			<img src="images/index_64.jpg" width="10" height="115" alt=""></td>
		<td rowspan="4">
			<a href="advertise.php?footerad=4">
				<img src="images/footerAD4.jpg" width="223" height="115" border="0" alt=""></a></td>
		<td colspan="2" rowspan="6">
			<img src="images/index_66.jpg" width="25" height="129" alt=""></td>
		<td>
			<img src="images/spacer.gif" width="1" height="29" alt=""></td>
	</tr>
	<tr>
		<td rowspan="5">
			<img src="images/index_67.jpg" width="6" height="100" alt=""></td>
		<td width="189" height="29" colspan="9"><a href="mailto:rigsale1@bigpond.net.au">rigsale1@bigpond.net.au</a></td>
		<td rowspan="5">
			<img src="images/index_69.jpg" width="13" height="100" alt=""></td>
		<td>
			<img src="images/spacer.gif" width="1" height="29" alt=""></td>
	</tr>
	<tr>
		<td colspan="9">
			<img src="images/index_70.jpg" width="189" height="28" alt=""></td>
		<td>
	...
	<tr>
		<td colspan="16" rowspan="2">
			<img src="images/index_72.jpg" width="920" height="14" alt=""></td>
		<td>
			<img src="images/spacer.gif" width="1" height="6" alt=""></td>
	</tr>
	<tr>
		<td colspan="9">
			<img src="images/index_73.jpg" width="189" height="8" alt=""></td>
		<td>
