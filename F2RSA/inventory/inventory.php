...
height: 100px; 
width: 300px; 
background-color:#04F; /* the critical component */ 
border-top: 4px solid #99B4FF; 
border-left: 4px solid #99B4FF; 
border-right: 4px solid #2E364C; 
border-bottom: 4px solid #2E364C; 
}
.box { 
color: #FFF; 
font-size: 80px; 
...
{	 
 ...
 ?> 
      ...
      <div style="font-size:12px">
New Seller? <a  style="background-color:#000" href="registration.php">Click here to Register</a>&nbsp;<br />
<a  style="background-color:#00F; color: #FFF;" href="login/overview.php">My Rigs/Equipment Dashboard</a></div>
</form>
 <?php 
 } 
 ...
 ?>
	...
	<tr>
		...
		<td colspan="4" align="center" valign="top" bgcolor="#FFFFFF"><?php if($page != 'blastholedrills' && $page != 'surplus' && $page != 'newprodsnservices'){ 
	...
	<tr>
	    ...
	    <tr>
	      <td align="center" valign="top" bgcolor="#FFFF99" style="border:solid"><form name="search" method="get" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
	        <p>      
		...
		<td width="695" height="218" colspan="4" align="center" valign="top" ><br /><?php
