...
<html>
<head>
<title>NEW! Seller Registration Rig Sales Australia</title>
   ...
   //Set Cookies
	$username = $_COOKIE['logincookie']; 
 	...
 	while($info = mysql_fetch_array( $check )) 	
 		...
 		elseif($info['username'] = admin && $pass == $info['password']){
			header("Location: login/classes/overviewA.php");
		}
		else
 			{
 			//header("Location: login/overview.php"); un Comment to send directly to Overview Page when user is already logged in and clicks sell
			//comment the next line out if you Uncomment the above line
echo 'Welcome '.$info['bizname'].'! <a href="login/overview.php">Your Dashboard</a> '; 
 ...
 //gives error if the password is wrong
 	if ($_POST['pass'] != $info['password']) {
 		echo 'Incorrect password <a href='.$_SERVER['PHP_SELF'].'>Try again.</a><br /> Your Post Password is: '.$_POST['pass'].'<br /> and your Info PW is: '.$info['password'];
 	}
 else 
 { 
...
{	 
 ...
 ?> 
      ...
      &nbsp;&nbsp;
      <input name="pass" type="password" size="10" maxlength="50" />
...
<a href="login/overview.php">My Rigs/Equipment Dashboard</a></div>
 ...
 ?> 
	...
	<tr>
		...
		<td colspan="24" rowspan="9" style="background-image:url(registration/images/middlePic_Center.jpg); background-repeat:no-repeat" align="center"><div style="width:80%" align="center"><br/><br/><br/><br/>Need Help? Call Us 041 3907649<br />
	...
	<tr>
		<td colspan="3" rowspan="4">
			<img src="registration/images/index_26.jpg" alt="" width="40" height="148" border="0"></td>
	...
	<tr>
		<td colspan="4" rowspan="3"><img src="registration/images/index_35.jpg" alt="" width="275" height="31" border="0"></td>
	...
	<tr>
		...
		<td colspan="4" rowspan="4">
			<a href="advertise.php?footeradfooterad=3">
		...
		<td rowspan="4">
			<a href="advertise.php?footeradfooterad=4">
