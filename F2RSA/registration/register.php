...
<h1>Registered</h1>
 <p><?php echo 'this is the MD5: '.$md5.' and this is whats inserted '.$_POST['pass']; ?>Thank you, you have registered - you may now login.</p>
 <?php 
}
} 
 else 
...
<tr>
 ...
 <tr><td>Confirm Password:</td><td><input type="password" name="pass2" maxlength="50" /></td></tr>
