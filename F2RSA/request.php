...
<table width="47%" border="0" cellspacing="0" cellpadding="0" align="center" style="border:solid">
  <tr bgcolor="#FFFFCC" style="font-size:14px; padding:0px; padding:">
    ...
    <td width="70%" align="center" valign="top" bgcolor="#FFFFFF"><img src="images/bigLogoHome.jpg" width="612" height="107" alt="Rig Sales Australia" /></td>
    <td width="1%" bgcolor="#FFFFFF">&nbsp;</td>
  ...
  <tr bgcolor="#FFFF99">
    ...
    <td align="center" valign="top" style="font-family:Verdana, Geneva, sans-serif; font-size:36px"><p>Make An Equipment Request</p></td>
    <td align="center" valign="top" style="font-family:Verdana, Geneva, sans-serif; font-size:36px">&nbsp;</td>
    <td align="center" valign="top" style="font-family:Verdana, Geneva, sans-serif; font-size:36px">&nbsp;</td>
    </tr> 
  <br />
  ...
  <form id="sentrequest" name="sentrequest" method="post" action="sentrequest.php">
    <tr bgcolor="#FFFF99">
      <td>&nbsp;</td>
      <td align="center">&nbsp;</td>
      <td></td>
    ...
    <tr bgcolor="#FFFF99">
      ...
      <td align="center" valign="top"> Full Name:  
    ...
    <tr bgcolor="#FFFF99">
      <td>&nbsp;</td>
      <td align="center" valign="top">Company Name:
        <input type="text" name="bizname" id="bizname" /></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr bgcolor="#FFFF99">
      <td>&nbsp;</td>
      <td align="center" valign="top">Phone:
    ...
    <tr bgcolor="#FFFF99">
      <td>&nbsp;</td>
      <td align="center" valign="top">Email Address:
    ...
    <tr bgcolor="#FFFF99">
      <td>&nbsp;</td>
      <td align="center" valign="top">Is this enquire for a New Rig/Equipment?
        <table width="200">
          <tr>
            <td><label>
              <input type="radio" name="newRig" value="yes" id="newRig_0" />
              Yes</label></td>
          </tr>
          <tr>
            <td><label>
              <input type="radio" name="newRig" value="no" id="newRig_1" />
              No</label></td>
          </tr>
        </table></td>
      <td>&nbsp;</td>
    ...
    <tr bgcolor="#FFFF99">
      <td height="85">&nbsp;</td>
      <td align="center" valign="top"><p>Your Equipment Request<br /><br />
        <textarea name="equipmentrequest" id="equipmentrequest" cols="45" rows="5"></textarea>
      </p>
        <p>
