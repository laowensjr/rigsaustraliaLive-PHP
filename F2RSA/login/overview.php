...
<title>Overview Of My Account</title>
<style type="text/css">
<!--
body {
...
<div>
  <div style="background-color:#FFF">
        <table width="100%" border="0" cellspacing="1" cellpadding="1">
          <tr>
            <td colspan="2" align="left" valign="top"><img src="../images/backendHeaders/myDashBoardBACKENDimageHEADERS.jpg" width="1223" height="117" /></td>
          </tr>
  </table>
...
<div style="width: 100%; overflow: hidden;"><br />
  <div style="margin-left:10px; width: 600px; height: 53px; float: left; color: #000;" id="myTitleNOUnderline" align="left"  >
    <b style="font-size:36px">
    Contact Details:&nbsp;&nbsp;&nbsp;</b>
  </div>
    <div style="margin-left: 650px; color: #00F;" align="left" id="myTitle"><h3>
      <img src="../images/sCrown.jpg" alt="" width="67" height="53" />Product Summary</h3>
    </div>
</div>
    <div style="width: 100%; overflow: hidden;">
  ...
  <tr>
    ...
    <td width="66%" align="left" valign="top" class="myNAMETitle"><br />
      Name: <?php echo @$fname ." ". @$lname;?><br /></td>
  </tr>
  <tr>
    <td align="left" valign="top" class="myNAMEDetails"><br />
    Company: <?php echo @$bizname;
	echo '<br />';
	?>
