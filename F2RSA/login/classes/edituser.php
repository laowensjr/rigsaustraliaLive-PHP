...
<div style="width: 100%; overflow: hidden;">
  <div style="margin-left:10px; width: 900px; float: left; " id="myTitleNOUnderline" align="left"><form action="<?php echo $_SERVER['PHP_SELF'].'?cmd=search'; ?>" method="get" enctype="application/x-www-form-urlencoded" name="search">
  Modify Premium Users' Profiles&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  </form><br /></div>
    <div style="margin-left: 650px;" align="left" id="myTitle"></div>
</div>

    <div style="width: 100%; overflow: hidden;">
    <div style="margin-left:10px; float: left; width: 1200px; border: 1px solid black; background-color: #FF9" align="left">
      
    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="myNAMEDetails">
  <tr>
    <td align="left" valign="top"><br />
      <?php include('editUserC.php'); ?>
      <?php 
	 if(!empty($_GET['bizid'])){
		$runEditUser = new editUserC();
		$runEditUser->getUserInfo();
	 }else{
		include('viewUserC.php');
		$runView = new viewUserC();
		$runView->getUserInfo();
	 }
