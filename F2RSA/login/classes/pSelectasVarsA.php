<?php
    class pSelectasVarsA{
    public $ptitle = NULL,
	$pcategory = NULL,
	$pldesc = NULL;	
    	
    function pSelectasVarsA(){
...
mysql_connect("localhost", "owenspcc_laowens", "lo19315761") or die(mysql_error()); 
 mysql_select_db("owenspcc_rigsalesaustralia") or die(mysql_error());
	$sql4selectingProducts = mysql_query("SELECT * FROM productinfo")or die(mysql_error());
	...
	$this->o1img = $myProductArray['o1img'];
		...
		<div style="margin-left:3px; width: 110px; float: left;"><b>&nbsp;&nbsp;<?php if($this->status != 'approved'){
			echo 'Under Review';	
				...
				echo 'Approved';
					} ?></b><br /><img src='<?php echo "../$this->o1img"; ?>' width="100" height="100" 	alt="Original Image 1" border="1px" /></div>
		
		<div style="margin-left: 130px;"> 
			<h2>Name:&nbsp;<?php echo $this->ptitle; ?><br />
		   Price:&nbsp;$<?php echo $this->pprice; ?></h2>
	  <a href="pictures.php?id=<?php echo "$this->id"?>;&ptitle=<?php echo "$this->ptitle"; ?>">Show All Pictures</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a  href="javascript:;"onclick="showMyProductPictures()">Show More Details</a> | <a href="modifyListingA.php?id=<?php echo "$this->id"?>">Modify</a> | <a href="deleteListingA.php?id=<?php echo "$this->id"?>">Delete</a></div>
