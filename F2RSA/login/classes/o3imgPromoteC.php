<?php
		...
		//This class creates the directory for the images location and stores the image.	
			function o3imgPromoteC(){
		if(isset($_POST['o3imgPromote'])){
			$ptitle = @$_GET['ptitle'];
...
$id = 1;
$sql4InsertPicture = "UPDATE promotedrigs SET o3img = '".$uploadfile."' WHERE username = '$username' AND id = '$id'";
