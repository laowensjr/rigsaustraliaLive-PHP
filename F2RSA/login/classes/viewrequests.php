...
<div style="width: 100%; overflow: hidden;">
  ...
  <tr>
    <td align="left" valign="top"><br />
     <?php //include('viewRequestsC.php'); ?>
     <?php 
	 /*
	 if(!empty($_GET['bizname'])){
		$runRequests = new viewRequestsC();
		$runRequests->getSRequests();
	 }else{
		$runRequests = new viewRequestsC();
		$runRequests->getAllPRequests();
	 }
	 */
	 include('viewProductListRequests.php');
	 $runRequests = new viewProductListRequests();
	 $runRequests->getProductDivs();
    ...
    <div style="margin-left: 840px; height: 200px; width: 200px; border: 1px solid black;"  align="left" id="myDetails" >
      <b>Instructions:</b>Listing Requests<br />
      <p>To See More Details of a User Request. Click &quot;Show More Details&quot;.</p>
    </div>
</div>
    <div style="width: 100%; overflow: hidden;">
