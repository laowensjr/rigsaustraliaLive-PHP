...
<title>View Listing Requests</title>
<style type="text/css">
<!--
body {
...
<div style="width: 100%; overflow: hidden;">
  ...
  <p style="font-size:14px;"><a href='promotedrigs.php'>Update Promoted Rig Details</a> / <a href='promotedrigsIadd.php'>Update Promoted Rig Pictures</a> (This is to update the Promoted Rig Only)</p>
  </div>
    <div style="margin-left: 650px;" align="left" id="myTitle">
  ...
  <tr>
    ...
    <?php 
	include('pSelectasVarsA.php');
	  $runProdDivs = new pSelectasVarsA();
    ...
    <div style="margin-left: 840px; height: 200px; width: 200px; border: 1px solid black;"  align="left" id="myDetails" >
      <b>Instructions:</b>View Rigs<br />
      <p><b>Note:</b> All Rigs that are listed as Approved are Live on your website. Deleting an Approved Rig/Equipment will completely remove it from the website. You may also choose to modify the Rig/Equipment, but again be mindful that these are live updates that will take effect immediately on your website</p>
    </div>
</div>
    <div style="width: 100%; overflow: hidden;">
