<?php
		...
		//This class creates the directory for the images location and stores the image.	
			function o1imgPromoteC(){
		if(isset($_POST['o1imgPromote'])){
			$ptitle = @$_GET['ptitle'];
...
$id = 1;
$sql4InsertPicture = "UPDATE promotedrigs SET o1img = '".$uploadfile."' WHERE username = '$username' AND id = '$id'";
