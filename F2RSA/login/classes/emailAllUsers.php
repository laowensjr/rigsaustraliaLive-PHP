...
<div style="width: 100%; overflow: hidden;">
  ...
  <tr>
    <td align="left" valign="top"><br />
      ...
      <?php 
	  include('emailAllUserC.php');
	 if($_GET['cmd'] == 'sendAllEmail'){?>
		 <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="sendnowAll">
				<p>To: All Premium USers<br />
				  <br />
				<p>Subject<br />
		...
		</form><?php }elseif(isset($_POST['sendnowAll'])){
						 $subject = $_POST['subject'];
						 $message = $_POST['message'];
						$runSendAll = new emailAllUserC($subject, $message);
						$runSendAll->sendAllEmail();
		}else{
			  header("Location: emailAllUsers.php?cmd=sendAllEmail");
		}
	 ?>
     </td>
  </tr>
    ...
    <div style="margin-left: 840px; height: 200px; width: 200px; border: 1px solid black;"  align="left" id="myDetails" ><b>Instructions:</b> Email ALL User<br />
      <p>To Email ALL Users just fill in the Subject and the Message and Press Send. The Email addresses are already entered for you.</p>
    </div>
</div>
    <div style="width: 100%; overflow: hidden;">
